...
const UsersList = () => {
  ...
  const fetchAdmins = async () => {
    try {
      setloading(true);
      const response = await axiosInstance.get(`panel/user/get/users`, {
        params: {
          page: currentPage,
          limit: itemsPerPage,
        },
  ...
  const toggleSurveyStatus = async (id, activate) => {
    try {
      const response = await axiosInstance.patch(
        `panel/user/edit/user/${id}/status`,
        {
          status: activate,
        },
        {
            ...
            <div className="admins_table">
              <div className="card table_card border-0 shadow">
                <div className="card-header row mx-0 align-items-center border-0">
                  <h6 className="col-md-4 col-12">Users List</h6>
                  <div className="col-md-8 col-12">
                    <div className="d-flex align-items-center justify-content-end w-100">
                      <div className="searchform_panel mr-1">
                ...
                {admins.length === 0 && (
                  <>
                    <div className="text-center">
                      <small className="text-small">No Users Found</small>
                    </div>
                  </>
                )}
