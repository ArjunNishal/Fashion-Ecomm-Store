  ...
  const fetchProducts = async () => {
    try {
      ...
      const response = await axiosInstance.get(
        `panel/product/featured-products/${cid}`,
        {
          params: {
            page: currentPage,
            limit: itemsPerPage,
        ...
        <div className=" mt-md-2  mt-0">
          <BreadcrumbPanel
            breadlinks={[
              ...
              {
                url: `/panel_catproduct?cid=${cid}&cidname=${cidname}`,
                text: cidname ? cidname : "Products",
              },
              {
                url: "/panel_featurecatproducts",
              ...
              <div className="card table_card border-0 shadow">
                <div className="card-header row mx-0 align-items-center border-0">
                  <h6 className="col-md-4 col-12">
                    Feature Products of&nbsp;
                    <text className="text-panel">{cidname}</text>
                  </h6>
...
export default FeatureProductByCat;
