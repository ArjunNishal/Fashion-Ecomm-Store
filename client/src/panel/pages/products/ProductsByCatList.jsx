...
const ProductsByCatList = () => {
  ...
  const cidname = searchParams.get("cidname");
  ...
  const fetchProducts = async () => {
    try {
      ...
      const response = await axiosInstance.get(
        `panel/product/getproductbycat/${cid}`,
        {
          params: {
            page: currentPage,
            limit: itemsPerPage,
              ...
              <div className="card table_card border-0 shadow">
                <div className="card-header row mx-0 align-items-center border-0">
                  <h6 className="col-md-4 col-12">
                    Products List of{" "}
                    <text className="text-panel">{cidname}</text> category
                  </h6>
                  <div className="col-md-8 col-12">
                    <div className="d-flex flex-sm-row flex-column align-items-sm-center align-items-end justify-content-end w-100">
                      ...
                      <Link
                        to={`/panel_featurecatproducts?cid=${cid}&cidname=${cidname}`}
...
export default ProductsByCatList;
